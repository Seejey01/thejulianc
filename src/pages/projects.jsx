...
const projects = [
  ...
  },
  {
    name: 'Bible Journey',
    description:
      'Experience the Romanian Bible in a minimalistic and slick design',
    link: {
      href: 'https://bible-journey.vercel.app/',
...
export default function Projects() {
  return (
    <>
      ...
      <SimpleLayout
        title="Side projects with potential."
        intro="For a bit of fun, because I enjoyed the idea, for testing out libraries and design, for the pure joy of creating. Checkout my projects."
      >
        <ul
          role="list"
